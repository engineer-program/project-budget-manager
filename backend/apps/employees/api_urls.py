...
from .views import (
    ...
    employee_bonus_save_view,
    employee_report_data_view,
    employee_salaries_bulk_save_view,
    employee_salaries_clear_columns_view,
    employee_salaries_copy_columns_view,
...
urlpatterns = [
    ...
    path("bonus-save/", employee_bonus_save_view, name="employee-bonus-save"),
    ...
    path(
        "salaries/clear-columns/",
        employee_salaries_clear_columns_view,
        name="employee-salaries-clear-columns",
    ),
    path(
        "salaries/copy-columns/",
        employee_salaries_copy_columns_view,
        name="employee-salaries-copy-columns",
    ),
]
